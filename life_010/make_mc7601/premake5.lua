...
solution "life-mc7601"
   ...
   project "life-mc7601-x86"
      ...
      language "C++"
      files { "**.h", "../src_pc/*.cpp"}
	  libdirs {   "$(MC7601)/libload", "$(HAL)/lib", "$(VSHELL)/lib", "$(NMPP)/lib" }
	  includedirs { "$(MC7601)/include", "$(HAL)/include", "$(VSHELL)/include", "$(NMPP)/include"  }
	  links { "mc7601_ll_pc.lib","hal-mc7601-x86d.lib", "vshell.lib", "nmpp-x86.lib", "life-mc7601-nmc3-0","life-mc7601-nmc3-1" }
